# Meerkats Picture
Here we decided to test the image with meerkats, a fairly simple task. You can see the original image below.
![meerkat test image](https://github.com/sidjik/obj-det-chat-qwen3-vl/blob/master/docs/images/test_meerkats/meerkats.jpeg)


### Question: 1

- *Question*: provide bounding box for meerkats heads
- *Output*: bounding box image with highlighted meerkats heads
...
- *Question*: Can you count the paws of each marmot and tell me how many there are in total?
- *Output*: Assistant provide text answer and image with higlighted paws
